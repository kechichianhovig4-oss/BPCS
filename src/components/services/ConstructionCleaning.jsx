          ...
          <main className="flex-1">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight tracking-[-0.033em]">
                    <span className="text-teal-600">Construction</span> Cleaning Services
                  </h1>
                  <p className="mt-4 text-gray-600 text-lg max-w-3xl mx-auto">
                    Professional post-construction cleaning for residential and commercial properties.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-white">
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  <div>
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Expert Post-Construction Cleaning</h2>
                    <p className="text-gray-600 text-lg leading-relaxed mb-4">
                      At Bayou Pristine Cleaning, we specialize in post-construction cleaning, ensuring that your newly built or renovated space is spotless and ready for occupancy. Whether it's a residential home, office, or commercial property, we understand the importance of a pristine finish after the dust settles. Our expert team handles all aspects of construction cleanup, from removing debris to detailing every corner of your property.
                    </p>
                    <p className="text-gray-600 text-lg leading-relaxed mb-4">
                      Let us take the stress out of post-construction cleaning, so you can enjoy your newly completed space without any worries. We'll handle the mess, so you can enjoy the results!
                    </p>
                    <p className="text-gray-600 text-lg leading-relaxed">
                      At Bayou Pristine Cleaning, we understand that you want your newly constructed or remodeled home or business to look flawless when it's ready to be shown off to the public or your friends and family. That's why you can trust us for expert post-construction cleaning. No matter the size of the project, we'll ensure your space is spotless, ready for its big reveal.
                    </p>
                  ...
                  <div>
                    <div className="bg-teal-50 rounded-2xl p-8 border border-teal-100 mb-8">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700"><strong>Debris removal:</strong> We clear all leftover construction materials and waste, ensuring your space is free of any construction remnants</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Dusting and wiping:</strong> Thorough dusting of all surfaces, including windowsills, baseboards, and light fixtures, leaving your space looking fresh</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Floor cleaning:</strong> Sweeping, mopping, and vacuuming floors to remove dust and dirt from construction</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Window and glass cleaning:</strong> Spotless windows and glass surfaces, ensuring they're streak-free and sparkling</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Restroom and kitchen cleaning:</strong> Sanitizing sinks, countertops, and appliances, making your bathrooms and kitchen shine</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Detailed touch-ups:</strong> Final detailing of all areas, including hard-to-reach spots, ensuring your space is ready for its grand reveal</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200 flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900">Heavy-Duty Construction Cleanup</h4>
                        <p className="text-sm text-gray-600">We handle the big jobs - from debris to final polish</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-gray-50">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Construction Cleaning Pricing</h2>
                  <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                    Post-construction cleaning rates are customized based on the size and scope of your project.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-teal-600">
                    <div className="text-center">
                      <span className="material-symbols-outlined text-5xl text-teal-600">home</span>
                      <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Small Renovation</h3>
                      <p className="text-gray-500 text-sm">Single room • Small addition</p>
                      <div className="my-4">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-teal-600 relative">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Medium Renovation</h3>
                      <p className="text-gray-500 text-sm">Multiple rooms • Full floor</p>
                      <div className="my-4">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-teal-600">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Large Renovation</h3>
                      <p className="text-gray-500 text-sm">Whole house • Multi-story</p>
                      <div className="my-4">
                ...
                <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Construction Cleaning Breakdown</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-600 text-sm">
                        <li>• Small (single room): Starting at $500</li>
                        <li>• Medium (multiple rooms): Starting at $1,500</li>
                        <li>• Large (whole house): Starting at $3,000</li>
                        <li>• Commercial (entire building): Starting at $5,000+</li>
                      </ul>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                        <span className="material-symbols-outlined text-teal-600">construction</span>
                        Scope of Work
                      </h4>
                      <ul className="space-y-2 text-gray-600 text-sm">
                        <li>• Debris and waste removal</li>
                        <li>• Deep dusting of all surfaces</li>
                        <li>• Floor cleaning (vacuum, sweep, mop)</li>
                        <li>• Window and glass polishing</li>
                        <li>• Kitchen and bathroom sanitation</li>
                        <li>• Final detailed touch-ups</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-teal-100">
                    <p className="text-sm text-gray-700 text-center">
                      <strong className="text-teal-600">Note:</strong> For larger renovation projects such as entire commercial buildings, warehouse conversions, or multi-story renovations, pricing may range from <strong>$5,000 to $15,000+</strong> depending on the size, scope, and complexity of the project. 
                      Contact us for a custom quote tailored to your specific construction cleaning needs.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600 mb-4">
                    Every construction project is unique. Let us create a custom cleaning proposal just for you.
                  </p>
                  <button 
                    onClick={openEstimateModal}
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-white">
              <div className="max-w-6xl mx-auto">
                ...
                <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
                  From removing debris to detailing every corner of your property, we handle it all so you can enjoy your newly completed space without any worries.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center p-6 bg-gray-50 rounded-xl">
                    <span className="material-symbols-outlined text-4xl text-teal-600">construction</span>
                    <h4 className="font-bold text-gray-900 mt-3">Heavy-Duty Cleanup</h4>
                    <p className="text-sm text-gray-600 mt-1">We handle debris, dust, and detailed cleaning</p>
                  </div>
                  <div className="text-center p-6 bg-gray-50 rounded-xl">
                    ...
                    <p className="text-sm text-gray-600 mt-1">We ensure your space is ready for its big reveal</p>
                  </div>
                  <div className="text-center p-6 bg-gray-50 rounded-xl">
                    <span className="material-symbols-outlined text-4xl text-teal-600">schedule</span>
                    <h4 className="font-bold text-gray-900 mt-3">On-Time Delivery</h4>
                    <p className="text-sm text-gray-600 mt-1">We work efficiently to meet your deadlines</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-teal-600">
              <div className="max-w-4xl mx-auto text-center text-white">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready for Your Big Reveal?</h2>
                <p className="text-lg mb-8 text-white/90">
                  Let us handle the construction mess so you can enjoy your newly completed space. Schedule your post-construction cleaning today!
                </p>
                <button 
                  onClick={openEstimateModal}
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                  ...
                  <option>Large (whole house/building)</option>
                  <option>Commercial (entire building)</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Message</label>
                <textarea rows="3" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent" placeholder="Tell us about your construction cleaning needs..."></textarea>
              </div>
