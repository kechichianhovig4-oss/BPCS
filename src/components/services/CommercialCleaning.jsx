          ...
          <main className="flex-1">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight tracking-[-0.033em]">
                    <span className="text-teal-600">Commercial</span> Cleaning
                  </h1>
                  <p className="mt-4 text-gray-600 text-lg max-w-3xl mx-auto">
                    Professional cleaning services tailored to meet the unique needs of your business.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-white">
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  <div>
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Professional Commercial Cleaning</h2>
                    <p className="text-gray-600 text-lg leading-relaxed mb-4">
                      At Bayou Pristine Cleaning, we understand the importance of maintaining a clean and professional environment for your business. Our commercial cleaning services are tailored to meet the unique needs of offices, retail spaces, and other commercial properties. Whether you're preparing for an inspection or simply want to maintain a clean, welcoming atmosphere, our team ensures that your space is spotless and ready to impress.
                    </p>
                    <p className="text-gray-600 text-lg leading-relaxed mb-4">
                      We offer a customized proposal based on your specific cleaning needs, ensuring that you get the best service at a competitive price. Our proposal outlines the services we'll provide, frequency of cleaning, and any special requests or requirements, giving you complete transparency and peace of mind.
                    </p>
                    <p className="text-gray-600 text-lg leading-relaxed">
                      We are dedicated to providing the highest quality commercial cleaning services, consistently exceeding the expectations of our clients, their employees, and visitors. Our goal is to create clean, welcoming, and professional environments that leave a lasting impression on everyone who enters your premises.
                    </p>
                    ...
                    <div className="bg-teal-50 rounded-2xl p-8 border border-teal-100 mb-8">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700"><strong>Floor care:</strong> Sweeping, vacuuming, and mopping of all floor types, including carpets, hardwood, and tile</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Office and workspace cleaning:</strong> Wiping down desks, chairs, and other furniture, as well as disinfecting high-touch areas like light switches and phones</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Restroom cleaning:</strong> Sanitizing toilets, sinks, and mirrors; replenishing soap, paper towels, and toilet paper; and ensuring all surfaces are spotless</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Kitchen and breakroom cleaning:</strong> Wiping down countertops, appliances, sinks, and surfaces to ensure a clean and hygienic area</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Dusting and surface cleaning:</strong> Dusting all furniture, baseboards, shelves, light fixtures, and vents, as well as wiping down windowsills</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Trash removal:</strong> Emptying trash bins and recycling bins, ensuring the space is free of clutter</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Windows and mirrors:</strong> Cleaning windows and mirrors to keep them streak-free and polished</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700"><strong>Final touch-up:</strong> A thorough check to ensure every area is pristine and ready for business</span>
                        </li>
                      </ul>
                    </div>

                    {/* Customized Proposal Badge */}
                    <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200 flex items-center gap-4">
                      <span className="material-symbols-outlined text-4xl text-teal-600">description</span>
                      <div>
                        <h4 className="font-bold text-gray-900">Customized Proposals</h4>
                        <p className="text-sm text-gray-600">Tailored to your specific cleaning needs and budget</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-gray-50">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Pricing That Fits Your Business</h2>
                  <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                    Our commercial cleaning rates are customized based on your business size, cleaning needs, and frequency.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-teal-600">
                    <div className="text-center">
                      <span className="material-symbols-outlined text-5xl text-teal-600">storefront</span>
                      <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Small Business</h3>
                      <p className="text-gray-500 text-sm">Up to 1,500 sq ft</p>
                      <div className="my-4">
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-teal-600 relative">
                    ...
                    <div className="text-center">
                      <span className="material-symbols-outlined text-5xl text-teal-600">business</span>
                      <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Medium Business</h3>
                      <p className="text-gray-500 text-sm">1,500 - 5,000 sq ft</p>
                      <div className="my-4">
                      ...
                      <ul className="mt-4 text-left space-y-2 text-sm">
                        <li className="flex items-center gap-2 text-gray-600">
                          <span className="material-symbols-outlined text-teal-600 text-sm">check</span>
                          Comprehensive commercial clean
                        </li>
                        <li className="flex items-center gap-2 text-gray-600">
                          <span className="material-symbols-outlined text-teal-600 text-sm">check</span>
                          Up to 8 hours
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-t-4 border-teal-600">
                    <div className="text-center">
                      <span className="material-symbols-outlined text-5xl text-teal-600">corporate_fare</span>
                      <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Large Business</h3>
                      <p className="text-gray-500 text-sm">5,000 - 10,000+ sq ft</p>
                      <div className="my-4">
                ...
                <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Customized Commercial Pricing</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-600 text-sm">
                        <li>• Small (up to 1,500 sq ft): Starting at $200/visit</li>
                        <li>• Medium (1,500 - 5,000 sq ft): Starting at $400/visit</li>
                        <li>• Large (5,000 - 10,000+ sq ft): Starting at $800/visit</li>
                      </ul>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                      ...
                      <ul className="space-y-2 text-gray-600 text-sm">
                        <li>• Daily service: Best for high-traffic businesses</li>
                        <li>• Weekly service: Perfect for regular maintenance</li>
                        <li>• Bi-weekly service: Ideal for smaller offices</li>
                        <li>• Monthly service: Great for periodic deep cleans</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-teal-100">
                    <p className="text-sm text-gray-700 text-center">
                      <strong className="text-teal-600">Note:</strong> For larger commercial properties such as entire office buildings, warehouses, or retail centers, pricing may range up to $2,000+ depending on the size, scope, and frequency of cleaning required. 
                      Contact us for a custom quote tailored to your specific business needs.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600 mb-4">
                    Every business is unique. Let us create a customized cleaning proposal just for you.
                  </p>
                  <button 
                    onClick={openEstimateModal}
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-white">
              <div className="max-w-6xl mx-auto">
                ...
                <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
                  Our commercial cleaning service ensures that your property is spotless and ready for inspections, meetings, or simply to impress your clients. Let us take care of the cleaning, so you can focus on running your business!
                </p>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center p-6 bg-gray-50 rounded-xl">
                    <span className="material-symbols-outlined text-4xl text-teal-600">description</span>
                    <h4 className="font-bold text-gray-900 mt-3">Customized Proposals</h4>
                    <p className="text-sm text-gray-600 mt-1">Tailored to your specific needs and budget</p>
                  </div>
                  <div className="text-center p-6 bg-gray-50 rounded-xl">
                  ...
                  <div className="text-center p-6 bg-gray-50 rounded-xl">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Daily, weekly, bi-weekly, or monthly visits</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-teal-600">
              <div className="max-w-4xl mx-auto text-center text-white">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Restore Your Business?</h2>
                <p className="text-lg mb-8 text-white/90">
                  We are committed to providing excellent commercial cleaning service. Schedule a virtual or in-person consultation today!
                </p>
                <button 
                  onClick={openEstimateModal}
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl relative">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <textarea rows="3" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent" placeholder="Tell us about your commercial cleaning needs..."></textarea>
              </div>
