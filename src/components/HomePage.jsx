          ...
          <main className="flex-1">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                  <div className="flex-1 text-center lg:text-left">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight tracking-[-0.033em]">
                      <span className="text-teal-600">Residential & Commercial</span>
                      <br />
                    ...
                    <p className="mt-4 text-gray-600 text-lg max-w-lg mx-auto lg:mx-0">
                      Refresh and renew your home or business with Bayou Pristine Cleaning Services!
                    </p>
                  ...
                  <div className="flex-1 grid grid-cols-2 gap-4">
                    <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                      <span className="material-symbols-outlined text-4xl text-teal-600">groups</span>
                      <h3 className="font-bold text-gray-900 mt-2">Experienced Staff</h3>
                      <p className="text-sm text-gray-600 mt-1">We hire and train friendly, skilled professionals</p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                      <span className="material-symbols-outlined text-4xl text-teal-600">monetization_on</span>
                      <h3 className="font-bold text-gray-900 mt-2">Affordable & Quality</h3>
                      <p className="text-sm text-gray-600 mt-1">We offer some of the most competitive cleaning</p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                      <span className="material-symbols-outlined text-4xl text-teal-600">verified</span>
                      <h3 className="font-bold text-gray-900 mt-2">Certified Company</h3>
                      <p className="text-sm text-gray-600 mt-1">We are a fully bonded and insured company</p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                      <span className="material-symbols-outlined text-4xl text-teal-600">star</span>
                      <h3 className="font-bold text-gray-900 mt-2">100% Satisfaction</h3>
                      <p className="text-sm text-gray-600 mt-1">Your satisfaction is our top priority</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="bg-teal-50 rounded-2xl p-8 border border-teal-100">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Environmentally friendly products safe for pets and children</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700">Trained and insured professional staff</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                        ...
                        <li className="flex items-start gap-3">
                          <span className="material-symbols-outlined text-teal-600">check_circle</span>
                          <span className="text-gray-700">Competitive pricing with premium service</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Residential Cleaning</h3>
                    ...
                    <button className="mt-4 text-teal-600 font-semibold hover:text-teal-700 transition-colors flex items-center gap-2">
                      Read More
                      <span className="material-symbols-outlined text-sm">arrow_forward</span>
                    </button>
                  </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Move In & Move Out Cleaning</h3>
                    <p className="text-gray-600">
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Commercial Cleaning</h3>
                    <p className="text-gray-600">
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mt-3 mb-2">Construction Cleaning</h3>
                    <p className="text-gray-600">
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-teal-600">
              <div className="max-w-4xl mx-auto text-center text-white">
                ...
                <p className="text-lg mb-8 text-white/90">
                  Try Louisiana's Best Residential & Commercial Cleaning Risk-Free Today
                </p>
                <button 
                  onClick={openEstimateModal}
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-white">
              <div className="max-w-6xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">We Provide The Highest Quality Residential & Commercial Cleaning Services in Louisiana</h2>
                <div className="flex flex-wrap justify-center gap-3 mt-8">
                  {['Monroe', 'West Monroe', 'Ruston', 'Alexandria', 'Shreveport', 'Bossier City', 'Lake Charles', 'Lafayette', 'Baton Rouge', 'New Orleans', 'Metairie', 'Kenner'].map((city, index) => (
                    <span key={index} className="bg-teal-50 text-teal-700 px-4 py-2 rounded-full text-sm font-medium border border-teal-100">
                      {city}
                    </span>
                  ))}
                </div>
                <div className="mt-12">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Restore Your Home or Business?</h3>
                  <button 
                    onClick={openEstimateModal}
                  ...
                  >
                    <span className="truncate">Get Your Free Estimate</span>
                  </button>
                </div>
              </div>
            </section>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-gray-50">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">Our Clients Love Us</h2>
