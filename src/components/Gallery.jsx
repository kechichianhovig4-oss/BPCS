...
function Gallery() {
  ...
  // Gallery images
  const images = [
    { id: 1, src: 'https://i.imgur.com/EbEbUT8.jpeg', alt: 'Cleaning service showcase 1' },
    { id: 2, src: 'https://i.imgur.com/C1mBo10.jpeg', alt: 'Cleaning service showcase 2' },
    { id: 3, src: 'https://i.imgur.com/F2hhju1.jpeg', alt: 'Cleaning service showcase 3' },
    { id: 4, src: 'https://i.imgur.com/PcyDJVr.jpeg', alt: 'Cleaning service showcase 4' },
    { id: 5, src: 'https://i.imgur.com/RRjQzYt.jpeg', alt: 'Cleaning service showcase 5' },
    { id: 6, src: 'https://i.imgur.com/hE8E3yX.jpeg', alt: 'Cleaning service showcase 6' },
    { id: 7, src: 'https://i.imgur.com/ruFpKcu.jpeg', alt: 'Cleaning service showcase 7' },
    { id: 8, src: 'https://i.imgur.com/Z2rkcyH.jpeg', alt: 'Cleaning service showcase 8' },
    { id: 9, src: 'https://i.imgur.com/FcEZ5OI.jpeg', alt: 'Cleaning service showcase 9' },
    { id: 10, src: 'https://i.imgur.com/OVZ7ju0.jpeg', alt: 'Cleaning service showcase 10' },
    { id: 11, src: 'https://i.imgur.com/mdxQ9Zk.jpeg', alt: 'Cleaning service showcase 11' },
  ];
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight tracking-[-0.033em]">
                    Bayou Pristine <span className="text-teal-600">Gallery</span>
                  </h1>
                  <p className="mt-4 text-gray-600 text-lg max-w-2xl mx-auto">
                    Take a look at our work and see the quality we bring to every job.
                  </p>
                </div>
              </div>
            </section>
                  ...
                  {images.map((image) => (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center">
                        <span className="material-symbols-outlined text-white text-4xl opacity-0 group-hover:opacity-100 transition-all duration-300">
                          zoom_in
                        </span>
                      </div>
                    </div>
            ...
            <section className="px-4 sm:px-10 lg:px-20 py-16 bg-teal-600">
              <div className="max-w-4xl mx-auto text-center text-white">
                ...
                <p className="text-lg mb-8 text-white/90">
                  See the difference professional cleaning can make. Contact us today for a free estimate.
                </p>
                <button 
                  onClick={openEstimateModal}
